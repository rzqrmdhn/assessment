...
<main class="main-content">
    <div class="container">
        ...
        <section class="content">
            ...
            <h2>Artikel Sports</h2>
            <?php
            // Query untuk mengambil data dari tabel post_article dengan category_id = 11 (Sports)
$query = "SELECT * FROM post_article WHERE category_id = 11";
$result = mysqli_query($conn, $query);
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td><h3><a href="full_article.php?post_id=' . $row['post_id'] . '">' . $row['title'] . '</a></h3>';
